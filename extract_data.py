...
assert data['yonkers']['4.-4655-60'] != [['******************************************************************************************************* 4.-4655-60 *****************']]
...
testset_mtpleasant = [
    ...
    ('99.20-1-29',['ROYE CAROL']),
    ('106.11-1-48',['TOCCI DONALD & B']),
    ('115.7-2-12',['TAPPAN AVE INC']),
    ('98.11-2-1',['COUNTRYSIDE RESIDENTS','ASSOCIATION INC']),
    ('105.15-1-66',['FOX HILL FARMS OF','WESTCHESTER LLC']),
]
    ...
    for line in data['mtpleasant'][key]:
        if line != '' and line != None and line != []:
            ...
            checks  = [
                ...
                'CONTIGUOUS PARCEL' in entry_line[0],
                'BANK' in entry_line[0],
                'MAY BE SUBJECT TO PAYMENT' in entry_line[0],
                'UNDER AGDIST TIL' in entry_line[0],
                bool(re.search('[A-Z]{2}[0-9]{3}',entry_line[0])),
                bool(re.search('@ [0-9]',entry_line[0])),
                bool(re.fullmatch('#[0-9]+',entry_line[0])),
...
# Test rye
testset_rye = [
    ('146-7-2-35',['PETRUCELLI JOHN F']),
    ('152-12-1-51',['MERKEL JAY SCOTT AND','DAWN HEATHER MERKEL']),
    ('153-6-1-68',['COFFEY TIMOTHY E','BURKE COFFEY HEATHER']),
]

for key,result in testset_rye:
    entry = []
    for line in data['rye'][key]:
        if line != '' and line != None and line != []:
            ...
            unique_checks = [ # Checks unique to owner name, not present in owner address
                'PO BOX' in entry_line[0],
            ]
            if True in checks or True in unique_checks:
                continue
            checks = [
                'PRIOR OWNER' in entry_line[0],
            ]
    ...
    try:
        ...
        for line in data['rye'][key]: print([line])
        print(entry)
        raise
...
testset_mtpleasant = [
    ...
    ('99.20-1-29','1 HARBOR SQUARE APT 310, OISSINING NY 10562'),
    ('106.11-1-48','1037 BROADWAY, THORNWOOD NY 10594'),
]
# Unsolved: ('106.5-2-73',''),
...
# Test rye
testset_rye = [
    ('146-7-2-35','130 BETSY BROWN RD, PORT CHESTER NY 10573'),
    ('146-15-1-40','5 CLARK LN, RYE NY 10580'),
    ('146-19-6-30','47 OAKWOOD AVE, RYE NY 10580'),
    ('153-5-1-58-1','19 YORK AVE, RYE NY 10580'),
    ('146-19-1-49','PO BOX 2451, 878 MONTAUK HIGHWAY, MONTAUK NY 11954'),
]
...
# Test yonkers
testset_yonkers = [
    ('2.-2323-22','50 Buckingham Rd, Yonkers, NY 10701'),
    ('3.-3236-29.31','188 Hoover Rd, Yonkers, NY 10710-3409'),
    ('6.-6359-37','128 Ridgewood Ave, Yonkers, NY 10704-2306'),
]
...
# Test rye
testset_rye = [
    ('146-12-2-46','210 1 FAMILY RES'),
    ('146-12-2-47','210 1 FAMILY RES'),
    ('146-19-3-62','210 1 FAMILY RES'),
]
...
# Test yonkers
testset_yonkers = [
    ('1.-478-79','330 Vacant comm'),
    ('4.-4471-41','210 1 Family Res'),
    ('4.-4863-34.35','210 1 Family Res'),
]
...
# Test rye
testset_rye = [
    ('146-10-1-20','18 SUMMIT AVE'),
    ('146-18-4-36','15 ELLSWORTH ST'),
    ('153-5-1-40','22 YORK AVE'),
]
...
# Test yonkers
testset_yonkers = [
    ('2.-2140-241','28 Jody Ln'),
    ('4.-4445-375','1853 Central Park Ave'),
    ('4.-4814-35','28 Agnola St'),
]
...
# Test rye with the generic function (SCHOOL DISTRICT)
testset_rye = [
    ('146-11-1-66','RYE CITY SCHOOLS'),
    ('146-18-4-36','RYE CITY SCHOOLS'),
    ('153-5-3-41','RYE CITY SCHOOLS'),
]

re_zoning = '(RYE CITY SCHOOLS|RYE NECK SCHOOLS)'
...
# Test yonkers with the generic function (SCHOOL DISTRICT)
testset_yonkers = [
    ('2.-2351-7.9','Yonkers City Sc 551800'),
    ('4.-4463-19','Yonkers City Sc 551800'),
    ('5.-5093-10','Yonkers City Sc 551800'),
]

re_zoning = '(Yonkers City Sc [0-9]{6})'
...
testset_rye = [
    ('146-15-3-20',[15800,15800,15800]),
    ('153-6-2-33',[25500,25500,25500]),
    ('153-7-3-83-3',[11300,11300,11300]),
]
...
taxable_names = {
    ...
    'town':'(TOWN TAXABLE|CITY TAXABLE( VALUE)?) -?[0-9,]+',
